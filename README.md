...
build the image from this checkout instead. Release builds display their tag
subtly beside the header branding; local builds display `development`. The service binds only to
